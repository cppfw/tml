...
tst::set set("read_ext", [](auto& suite){
	suite.add("correct_extra_info_is_provided", [](){
		...
		tst::check(!hello.value.get_info().flags.get(treeml::flag::raw), SL);
		tst::check_eq(hello.value.get_info().location.line, size_t(2), SL);
		tst::check_eq(hello.value.get_info().location.offset, size_t(4), SL);
		...
		tst::check(!world.value.get_info().flags.get(treeml::flag::raw), SL);
		tst::check_eq(world.value.get_info().location.line, size_t(2), SL);
		tst::check_eq(world.value.get_info().location.offset, size_t(9), SL);
		...
		tst::check(!how.value.get_info().flags.get(treeml::flag::raw), SL);
		tst::check_eq(how.value.get_info().location.line, size_t(3), SL);
		tst::check_eq(how.value.get_info().location.offset, size_t(4), SL);

		{
			...
			tst::check(!doing.value.get_info().flags.get(treeml::flag::raw), SL);
			tst::check_eq(doing.value.get_info().location.line, size_t(3), SL);
			tst::check_eq(doing.value.get_info().location.offset, size_t(17), SL);
			...
			tst::check(!qm.value.get_info().flags.get(treeml::flag::raw), SL);
			tst::check_eq(qm.value.get_info().location.line, size_t(3), SL);
			tst::check_eq(qm.value.get_info().location.offset, size_t(24), SL);
		}
		...
		tst::check(!im.value.get_info().flags.get(treeml::flag::raw), SL);
		tst::check_eq(im.value.get_info().location.line, size_t(4), SL);
		tst::check_eq(im.value.get_info().location.offset, size_t(5), SL);
