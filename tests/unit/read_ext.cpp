...
tst::set set("read_ext", [](auto& suite){
	suite.add("correct_extra_info_is_provided", [](){
		...
		tst::check(!hello.value.info.flags.get(treeml::flag::space), SL);
		tst::check(!hello.value.info.flags.get(treeml::flag::quoted), SL);
		tst::check(!hello.value.info.flags.get(treeml::flag::raw), SL);
		...
		tst::check(world.value.info.flags.get(treeml::flag::quoted), SL);
		tst::check(!world.value.info.flags.get(treeml::flag::space), SL);
		tst::check(!world.value.info.flags.get(treeml::flag::raw), SL);
		...
		tst::check(how.value.info.flags.get(treeml::flag::space), SL);
		tst::check(!how.value.info.flags.get(treeml::flag::quoted), SL);
		tst::check(!how.value.info.flags.get(treeml::flag::raw), SL);
...

		{
			...
			tst::check(doing.value.info.flags.get(treeml::flag::space), SL);
			tst::check(doing.value.info.flags.get(treeml::flag::quoted), SL);
			tst::check(!doing.value.info.flags.get(treeml::flag::raw), SL);
			...
			tst::check(!qm.value.info.flags.get(treeml::flag::space), SL);
			tst::check(!qm.value.info.flags.get(treeml::flag::quoted), SL);
			tst::check(!qm.value.info.flags.get(treeml::flag::raw), SL);
		...
		tst::check(!im.value.info.flags.get(treeml::flag::space), SL);
		tst::check(!im.value.info.flags.get(treeml::flag::quoted), SL);
		tst::check(!im.value.info.flags.get(treeml::flag::raw), SL);
